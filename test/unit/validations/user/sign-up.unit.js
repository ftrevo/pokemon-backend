...
const { '/user/sign-up': signUp } = require('../../../../src/validations');
...
describe('# Sign-up - Validation', () => {
  ...
  describe('## input', () => {
    describe('### success', () => {
      ...
      it('name password email and removing additional fields', async () => {
        const { value, error } = await signUp.post.body.validate({
          ...baseInput,
          additional: 'field',
        }, options);
  ...
  describe('## output', () => {
    describe('### success', () => {
      ...
      it('_id name email createdAt and removing additional fields', async () => {
        const { value, error } = await signUp.post.out.validate({
          ...baseInput,
          additional: 'field',
        }, options);
