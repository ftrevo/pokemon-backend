      ...
      describe('error', () => {
        ...
        it('invalid type', async () => {
          ...
          expect(error).toHaveProperty('details', [
            {
              message: '"id" deve ser uma string', path: ['_id'], type: 'string.base', context: { label: 'id', value: 1, key: '_id' },
            },
            {
              message: '"token" deve ser uma string', path: ['token'], type: 'string.base', context: { label: 'token', value: true, key: 'token' },
            },
            {
